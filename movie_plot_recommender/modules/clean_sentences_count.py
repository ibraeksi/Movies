...
def clean_sentences_count(sentence):
    ...
    english_stopwords = ["a", "about", "above", "after", "again", "against", "ain",
                         ...
                         "have", "haven", "haven't", "having", "he", "he'd", "he'll", "her",
                         "here", "hers", "herself", "he's", "him", "himself", "his", "how",
                         "i", "i'd", "if", "i'll", "i'm", "in", "into", "is", "isn", "isn't",
                         "it", "it'd", "it'll", "it's", "its", "itself", "i've", "just", "ll",
                         ...
                         "we're", "were", "weren", "weren't", "we've", "what", "when", "where",
    ...
    noun_lemmatized = [word for word in tokenized_sentence if not word in english_stopwords]
